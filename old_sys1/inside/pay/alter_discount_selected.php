                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left input_mask" method="post" action="pay/alter_discount_selected_q.php">
					  ...
					  <br>
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input class="form-control" type="text" name="remark22" value='<?php echo $discount_remark; ?>'>
                        </div>
                      </div>
					  ...
					  <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input class="form-control"  type="text" name="max_disc_per" id="max_disc_per" value="0" >	
