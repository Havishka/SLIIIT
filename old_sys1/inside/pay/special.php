                    ...
                    <form class="form-horizontal form-label-left input_mask" method="post"  action="pay/special_q.php">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="text" class="form-control" name='name' value='<?php echo $fname;  ?>' disabled >
                        </div>
                      </div>
					  ...
					  <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="text" class="form-control" name="item23" id="item23" placeholder="Choose Month..." value="<?php echo date("Y-m-d"); ?>"  readonly="readonly">								  
                        </div>
                      </div>
					  ...
					  <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="text" name="cfee" id="cfee" class="form-control"  onkeyup="getspecialc_fee()" value='<?php echo $course_fee; ?>'   >	
...
<script>
					  ...
					  <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input  type="text" onkeyup="getdiscount();" name='specialprice' id="specialprice" class="form-control" value='<?php echo $course_fee*2; ?>'  >	
					  ...
					  <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input class="form-control"  type="text" name="txt3" id="txt3" value="" >	
					  ...
					  <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="text" name="last" id="last" class="form-control" value='' >	
