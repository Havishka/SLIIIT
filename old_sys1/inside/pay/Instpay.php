		  ...
		  if($ins3!=null && $ins3!=0 )
			...
			?>				
					  ...
					  <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input class="form-control" onkeyup="getdiscount(); f_amount(); checkdiscount(); " type="number" name="txt2" id="txt2" value="">	
					  ...
					  <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Your final Amount :</label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
					  ...
					  <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="text" name='inst_pay' id='inst_pay' class="form-control" value='' required>	
