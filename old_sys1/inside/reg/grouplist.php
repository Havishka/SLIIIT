...
<tr><td align="center" style="text-align: left"><?php echo $count; ?></td><td align="center" bgcolor="#FFFF99" style="text-align: left"><?php echo $row["name"]; ?></td><td align="center" bgcolor="#FFFF99" style="text-align: left"><?php echo $row["ln"]; ?></td><td align="center" bgcolor="#FFFF99" style="text-align: left"><?php echo $row["nicc"]; ?></td><td align="center" style="text-align: left"><?php echo $row["ad"]; ?></td><td align="center"><a href="reg/delete.php?id=<?php echo $row["stdnum"];?>" class="btn btn-danger">Delete</a></td></tr>
<?php $count++; } ?>
</tbody>
</table>
