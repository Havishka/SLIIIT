...
return;
 ...
 function createInput(){
  ...
  for(var i=0;i<field_arr.length;i++){
	  ...
	  if((i!=2)||(i!=4)){
	  blankrow+= "<td class='ajaxreq'><input type='"+field_arr[i]+"' name='"+field_name[i]+"' placeholder='"+field_pre_text[i]+"' id='other-box' size='"+wsize[i]+"'/></td>";
	  }else if(i=2){
		 blankrow+="<div class='frmSearch'>";
		blankrow+= "<td class='ajaxreq'><input type='"+field_arr[i]+"' name='"+field_name[i]+"' placeholder='"+field_pre_text[i]+"' id='search-box' onkeypress='myFunction()'  size='"+wsize[i]+"' /></td>";  
		blankrow+= "<div id='suggesstion-box'></div></div>";
	  }
