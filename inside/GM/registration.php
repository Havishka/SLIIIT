...
if (isset($_POST['submit'])) {
    ...
    $query = mysqli_query($con, "insert into  lecture_reg (nic,f_name,l_name,email,phone,r_date) value('$username','$firstname','$lastname','$email','$phone','$rdate')");
    if ($query) {
 ...
 <div class="content-wrapper">
  ...
  <fieldset>
    ...
    <div class="control-group">
      ...
      <div class="controls">
        <input type="date" id="rdate" name="rdate" placeholder="" class="input-xlarge" required>
