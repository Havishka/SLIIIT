...
if(isset($_POST['submit']))
    ...
    $eid=$_GET['editid'];
        ...
        $query=mysqli_query($con, "update c_assign  set l_name='$search2', c_name='$search3' where id='$eid'");
        if ($query) {
        ...
        <div class="frmSearch">
            ...
            <?php
                ...
                <div class="form-group">
                    ...
                    <br> <input type="text" id="search-box" name="search-box"  size="60"   value="<?php  echo $row['l_name']; ?>"/>
