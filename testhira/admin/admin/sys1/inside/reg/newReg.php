...
$query3="insert into student_course ( std_id ,course_id , sc_date) values ( '$sysID', '$course_id','$newdate' )";
...
$count=$rows['count_course'];
				...
				if (!($result ))
				...
				else
				  {
					...
					echo "<script>alert('Student creation was Successful'); window.location.href = 'index.php?tab=all'; </script>";
