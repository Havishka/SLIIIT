...
if($le==1){
	...
	//$tabs ="";	
	$tabs = '	 <li><a><i class="fa fa-edit"></i>Discounts<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="index.php?tab=discountapr">View Approvals</a></li>
                       <li><a href="index.php?tab=alterdiscount">Alter Discounts</a></li>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="img/adminn.png" alt="">User ( Level <?php echo $le;?> ): <?php echo $login_name;?> (<?php echo $login_user;?>)
