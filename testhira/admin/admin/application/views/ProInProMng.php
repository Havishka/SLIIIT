...
and design</h1>
    ...
    <!--left-->
    	<div class="col-md-9 left-content aboutus-page">
        	<h2 class="red-heading">Professional Course on Project Management</h2>
        ...
        <p>The Professional courses are designed for engineers and management professionals who have sufficient exposure to project management concepts and practices and for working professionals, who want to launch a career in project management. Though Project Management is common for all industrial and operational functions, the focus of training can be customized to have an appeal to different sectors such as mechanical, civil, electrical, management and information technology. </p>
         <hr>
       
         <h4 class="blue-heading">Course Highlights  </h4>
            <ul>
            	<li>86 Contact hours  </li>
        ...
        <p>These are the courses that you have to complete to obtain Professional Course on Project Management</p>
