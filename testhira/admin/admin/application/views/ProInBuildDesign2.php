...
and design</h1>
    ...
    <!--left-->
    	<div class="col-md-9 left-content aboutus-page">
        	<h2 class="red-heading">Professional in Building Design</h2>
        ...
        <p>Thease are the courses that you have to complete to get Diploma in CAD</p>
        ...
        <ul><li><a href="<?php echo base_url(); ?>courses/oracle_primavera">Oracle Primavera</a></li></ul>
