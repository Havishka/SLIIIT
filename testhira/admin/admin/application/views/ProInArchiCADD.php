...
and design</h1>
    ...
    <!--left-->
    	<div class="col-md-9 left-content aboutus-page">
        	<h2 class="red-heading">Professional Course on Architectural CADD</h2>
        ...
        <p>CADD Centre’s Professional programs in Architectural CADD is suitable for engineers and experienced diploma engineers in the Civil/Architectural stream. This program will help the participants to improve the productivity skills and improve their career prospects. Participants will benefit greatly from this program and will help them to keep abreast of the latest technology. The course imparts training to the students in all the stages of building design, starting from 2D drawing, 3D modeling and Project management. </p>
        ...
        <p>These are the courses that you have to complete to obtain Professional Course on Architectural CADD</p>
        <ul><li><a href="<?php echo base_url(); ?>courses/auto_cad_2D">Auto CAD 2D</a></li></ul>
        <ul><li><a href="<?php echo base_url(); ?>courses/max_eng">3D MAX</a></li></ul>
