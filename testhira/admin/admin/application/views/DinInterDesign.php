...
and design</h1>
    ...
    <!--left-->
    	<div class="col-md-9 left-content aboutus-page">
        	<h2 class="red-heading">Diploma in Interior Design</h2>
        ...
        <p>CADD Centre's advanced programs are best suited for the fresh diploma and engineering students. This program gives the basic understanding and facilitates participants to make design comfortably. This provides the students good understanding on Drafting and Modeling tools used in Civil and Architectural industry. </p>
      
            <hr>
         <h4 class="blue-heading">Course Highlights  </h4>
            <ul>
            	<li>100 Contact hours  </li>
        ...
        <p>These are the courses that you have to complete to obtain Diploma in Interior Design</p>
