...
if($user_role == '2'){
    $sql15 = "Select s.`name`,s.nic,s.idstudent from course_has_student cs inner join student s  on cs.student_idstudent=s.idstudent where cs.course_idcourse='$course'";
}else if($user_role == '1'){
